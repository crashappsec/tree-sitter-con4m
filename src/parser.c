...
enum {
  ...
  sym_if_statement = 52,
  sym__if_stmt = 53,
  sym__if_elif_stmt = 54,
  sym__if_elif_else_stmt = 55,
  sym__if_else_stmt = 56,
  sym_elif_clause = 57,
  sym_else_clause = 58,
  sym_true = 59,
  sym_false = 60,
  ...
  aux_sym__statement_list_repeat1 = 64,
  aux_sym__if_elif_stmt_repeat1 = 65,
  aux_sym__if_elif_stmt_repeat2 = 66,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_expression_list] = STATE(31),
    [sym_assignment_statement] = STATE(75),
    [sym_if_statement] = STATE(75),
    [sym__if_stmt] = STATE(83),
    [sym__if_elif_stmt] = STATE(93),
    [sym__if_elif_else_stmt] = STATE(97),
    [sym__if_else_stmt] = STATE(74),
    [sym_true] = STATE(14),
    [sym_false] = STATE(14),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(107)] = 2162,
  [SMALL_STATE(108)] = 2172,
  [SMALL_STATE(109)] = 2182,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(14),
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(12),
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(13),
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(108),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(10),
  ...
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_statement, 1),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_list, 2),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_true, 1),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_false, 1),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_list, 1),
  [101] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_list_repeat1, 2), SHIFT_REPEAT(21),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_list_repeat1, 2),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, .production_id = 5),
  ...
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_elif_stmt, 4, .production_id = 10),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_elif_stmt, 4, .production_id = 10),
  [168] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [170] = {.entry = {.count = 1, .reusable = false}}, SHIFT(107),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_stmt, 3, .production_id = 6),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_stmt, 3, .production_id = 6),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_elif_stmt, 5, .production_id = 13),
  ...
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_elif_stmt, 5, .production_id = 13),
  [192] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__if_elif_stmt_repeat2, 2, .production_id = 15),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__if_elif_stmt_repeat2, 2, .production_id = 15),
  [198] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__if_elif_stmt_repeat2, 2, .production_id = 15), SHIFT_REPEAT(29),
  [201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [203] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__if_elif_stmt_repeat2, 2, .production_id = 15), SHIFT_REPEAT(28),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_list, 1),
  [208] = {.entry = {.count = 1, .reusable = false}}, SHIFT(27),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__if_elif_stmt_repeat2, 1, .production_id = 8),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__if_elif_stmt_repeat2, 1, .production_id = 8),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_list_repeat1, 2),
  [216] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_list_repeat1, 2), SHIFT_REPEAT(20),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3),
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_list, 2),
  [225] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_elif_clause, 3, .production_id = 6),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_elif_clause, 3, .production_id = 6),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2),
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2),
  [235] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_list_repeat1, 2), SHIFT_REPEAT(27),
  [238] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, .production_id = 5),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_true, 1),
  [242] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_false, 1),
  [244] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [246] = {.entry = {.count = 1, .reusable = false}}, SHIFT(6),
  [248] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement_list, 2),
  [250] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__if_elif_stmt_repeat1, 2), SHIFT_REPEAT(68),
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__if_elif_stmt_repeat1, 2),
  [255] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(8),
  [258] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(8),
  [261] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2),
  [263] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [265] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement_list, 1),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_statement, 3, .production_id = 7),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_statement, 3, .production_id = 7),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 1, .production_id = 4),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 1, .production_id = 4),
  [277] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [279] = {.entry = {.count = 1, .reusable = false}}, SHIFT(19),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_else_stmt, 4, .production_id = 9),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_else_stmt, 4, .production_id = 9),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_elif_else_stmt, 5, .production_id = 14),
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_elif_else_stmt, 5, .production_id = 14),
  [291] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_clause, 2, .production_id = 11),
  [293] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else_clause, 2, .production_id = 11),
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_else_stmt, 5, .production_id = 12),
  [297] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_else_stmt, 5, .production_id = 12),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 1, .production_id = 1),
  [301] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 1, .production_id = 1),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_elif_else_stmt, 6, .production_id = 16),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_elif_else_stmt, 6, .production_id = 16),
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_elif_else_stmt, 6, .production_id = 17),
  [309] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_elif_else_stmt, 6, .production_id = 17),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__if_elif_else_stmt, 7, .production_id = 18),
  [313] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__if_elif_else_stmt, 7, .production_id = 18),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 1, .production_id = 3),
  [317] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 1, .production_id = 3),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 1, .production_id = 2),
  [321] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 1, .production_id = 2),
